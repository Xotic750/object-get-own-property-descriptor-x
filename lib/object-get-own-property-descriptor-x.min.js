 ...
 */
"use strict";var getOPDFallback,$getOwnPropertyDescriptor,toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),nativeGOPD="function"==typeof Object.getOwnPropertyDescriptor&&Object.getOwnPropertyDescriptor,doesGOPDWork=function(object,prop){try{return object[toPropertyKey(prop)]=0,0===nativeGOPD(object,prop).value}catch(ignore){return!1}};if(nativeGOPD&&("undefined"==typeof document||doesGOPDWork(document.createElement("div"),"sentinel")))if(doesGOPDWork({},"sentinel")){var worksWithPrim;try{nativeGOPD(42,"name"),worksWithPrim=!0}catch(ignore){}$getOwnPropertyDescriptor=_dereq_("has-symbol-support-x")&&doesGOPDWork({},Object(Symbol("")))?worksWithPrim?nativeGOPD:function getOwnPropertyDescriptor(object,property){return nativeGOPD(toObject(object),property)}:worksWithPrim?function getOwnPropertyDescriptor(object,property){return nativeGOPD(object,toPropertyKey(property))}:function getOwnPropertyDescriptor(object,property){return nativeGOPD(toObject(object),toPropertyKey(property))}}else getOPDFallback=nativeGOPD;if(function _isFalsy(value){return!1===Boolean(value)}($getOwnPropertyDescriptor)||getOPDFallback){var lookupGetter,lookupSetter,owns=_dereq_("has-own-property-x"),isPrimitive=_dereq_("is-primitive"),isString=_dereq_("is-string"),isDigits=function _isDigits(key){return/^\d+$/.test(key)},prototypeOfObject=Object.prototype,propertyIsEnumerable=prototypeOfObject.propertyIsEnumerable,isEnumerable=function _isEnumerable(object,property){return propertyIsEnumerable.call(object,property)},supportsAccessors=owns(prototypeOfObject,"__defineGetter__");if(supportsAccessors){var lg=prototypeOfObject.__lookupGetter__,ls=prototypeOfObject.__lookupSetter__;lookupGetter=function(object,property){return lg.call(object,property)},lookupSetter=function(object,property){return ls.call(object,property)}}$getOwnPropertyDescriptor=function getOwnPropertyDescriptor(object,property){var obj=toObject(object),propKey=toPropertyKey(property);if(getOPDFallback)try{return getOPDFallback.call(Object,obj,propKey)}catch(ignore){}var descriptor,isStringIndex=isString(obj)&&isDigits(propKey)&&propKey<obj.length;if(!1===isStringIndex&&!1===owns(obj,propKey))return descriptor;if(descriptor={configurable:!1===isPrimitive(object)&&!1===isStringIndex,enumerable:isEnumerable(obj,propKey)},supportsAccessors){var prototype=obj.__proto__,notPrototypeOfObject=obj!==prototypeOfObject;notPrototypeOfObject&&(obj.__proto__=prototypeOfObject);var getter=lookupGetter(obj,propKey),setter=lookupSetter(obj,propKey);if(notPrototypeOfObject&&(obj.__proto__=prototype),getter||setter)return getter&&(descriptor.get=getter),setter&&(descriptor.set=setter),descriptor}return isStringIndex?(descriptor.value=obj.charAt(propKey),descriptor.writable=!1):(descriptor.value=obj[propKey],descriptor.writable=!0),descriptor}}module.exports=$getOwnPropertyDescriptor},{"has-own-property-x":2,"has-symbol-support-x":3,"is-primitive":8,"is-string":9,"to-object-x":15,"to-property-key-x":17}],2:[function(_dereq_,module,exports){/**
